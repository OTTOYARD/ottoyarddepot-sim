...
export const DepotSVG = forwardRef<SVGSVGElement>((_, ref) => {
  ...
  return (
    ...
    >
      ...
      <text x={30} y={15} textAnchor="middle" fontSize={3.5} fill="#2196F3" fontWeight="bold" opacity={0.6}>WASH</text>
      <text x={165} y={165} textAnchor="middle" fontSize={5} fill="#F59E0B" fontWeight="bold" opacity={0.6}>STAGING</text>
