...
function transport(over: Partial<BootTransport> = {}): BootTransport {
  return {
    ...
    offsite: async () => ({
      ...
      arrival_jitter_min_p50: null, arrival_jitter_delayed_n: 0,
      arrival_jitter_min_max: null, by_return_trigger: {},
    }),
    labor: async () => ({
      ...
      lanes: { wash_cap: null, service_cap: null, deploy_cap: null,
               charge_cap: null, charge_stalls_physical: null,
               charge_cap_basis: null, patience_min: null, observed_at: null },
